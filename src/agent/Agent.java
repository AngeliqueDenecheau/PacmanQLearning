...
public class Agent {
	...
	public void update(PacmanGame game, PositionAgent newPos, double reward, boolean finJeu) {
		
		this._behavior_normal.update(game, newPos, reward, finJeu, this.memoryAgent);
